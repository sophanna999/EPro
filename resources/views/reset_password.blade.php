          ...
          <div class="row">
            ...
            <div class="row">
              <div class="col-md-6 col-md-offset-3 form-horizontal mt-sm">
                ...
                <div class="form-group">
                  <label class="control-label col-md-4 text-right text-left-xs">Password Again</label>
                  <div class="col-md-8">
                ...
                <div class="form-group">
                  <div class="col-xs-12 col-md-8 col-md-offset-4">
                    <button class="btn-primary btn" type="submit">Sent</button>
                  </div>
                </div>
              </div>
            </div>
...
<script>
  $('#FormResetPassword').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/ChangeResetPassword",
                dataType : 'json',
                data : $(form).serialize()
            }).done(function(rec){
                if(rec.status==1){
                  ...
                  swal({
                      ...
                      window.location = url_gb+"/Customer/Login";
                    });
