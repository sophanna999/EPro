              ...
              <div class="container-fluid">
                <div class="col-xs-12 form-horizontal">
                  ...
                  <div class="residential" id="residential">
                    <form id="FormAddResidentail" enctype="multipart/form-data" method="post">
                      <div class="form-group">
                      ...
                      <div class="form-group mt-xs">
                        ...
                        <div class="col-xs-12 col-sm-5">
                          <input class="form-control checked_class r_avg_consumtion" type="text" name="r_avg_consumtion" id="r_avg_consumtion" value="">
                        </div>
                      </div>
                      <!-- <div class="form-group mt-xs">
                        <label class="control-label col-xs-4 text-right">Upload Image <img src="{{asset('assets/front/img/info.png')}}" data-toggle="tooltip" data-placement="bottom" title="Upload past electricity bill to get a more accurate quotation" alt="" width="20px" height="20px"></label>
                        <div class="col-xs-12 col-sm-5">
                          <div class="checked_class" id="ResidentailPhoto" orakuploader="on" name="ResidentailPhoto[]"></div>
                        </div>
                      </div> -->
                      <div class="form-group mt-xs">
                        <label class="control-label col-xs-4 text-right">Upload Bill Image <img src="{{asset('assets/front/img/info.png')}}" data-toggle="tooltip" data-placement="bottom" title="Upload past electricity bill to get a more accurate quotation" alt="" width="20px" height="20px"></label>
                        <div class="col-xs-12 col-sm-5">
                          <input type="file" class="form-control" id="ResidentailPhoto1" name="ResidentailPhoto1">
                          <img id="img_preview1" class="img_preview" src="#" alt="your image" style="width: 100px, height:100px; display: none" />
                        </div>
                      </div>
                      <div class="form-group mt-xs">
                        <label class="control-label col-xs-4 text-right">Upload Bill Image <img src="{{asset('assets/front/img/info.png')}}" data-toggle="tooltip" data-placement="bottom" title="Upload past electricity bill to get a more accurate quotation" alt="" width="20px" height="20px"></label>
                        <div class="col-xs-12 col-sm-5">
                          <input type="file" class="form-control" id="ResidentailPhoto2" name="ResidentailPhoto2">
                          <img id="img_preview2" class="img_preview" src="#" alt="your image" style="width: 100px, height:100px; display: none" />
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="col-sm-6 col-sm-offset-4">
                        <div class="form-group mt-xs">
                          <div class="col-xs-12 text-left">
                            <h4 class="label" style="color:#000;">Preferred Electricity Price Model</h4>
                          </div>
                        </div>
                  ...
                  <div class="business hide" id="business">
                   <form id="FormAddBusiness">
                    <input type="hidden" name="email" value="support@wattprice.com">
                    <div class="form-group">
                    ...
                    <div class="form-group mt-xs">
                      <label class="control-label col-xs-4 text-right"> Average Consumption kWh <img src="{{asset('assets/front/img/info.png')}}" data-toggle="tooltip" data-placement="top" title="You can enter average or images"  alt="" width="20px" height="20px"></label> 
                      <div class="col-xs-12 col-sm-5">
                        <input class="form-control checked_class b_avg_consumtion" type="text" name="b_avg_consumtion" id="b_avg_consumtion" value="">
                      </div>
                    </div>
                    <!-- <div class="form-group mt-xs">
                    ...
                    <div class="form-group mt-xs">
                      <label class="control-label col-xs-4 text-right">Upload Bill Image <img src="{{asset('assets/front/img/info.png')}}" data-toggle="tooltip" data-placement="bottom" title="You can enter average or images" alt="" width="20px" height="20px"></label>
                      <div class="col-xs-12 col-sm-5">
                        <input type="file" class="form-control" id="BusinessPhoto1" name="BusinessPhoto1">
                        <img id="img_preview3" class="img_preview" src="#" alt="your image" style="width: 100px, height:100px; display: none" />
                      </div>
                    </div>
                    <div class="form-group mt-xs">
                      <label class="control-label col-xs-4 text-right">Upload Bill Image <img src="{{asset('assets/front/img/info.png')}}" data-toggle="tooltip" data-placement="bottom" title="You can enter average or images" alt="" width="20px" height="20px"></label>
                      <div class="col-xs-12 col-sm-5">
                        <input type="file" class="form-control" id="BusinessPhoto2" name="BusinessPhoto2">
                        <img id="img_preview4" class="img_preview" src="#" alt="your image" style="width: 100px, height:100px; display: none" />
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="control-label col-xs-4 text-right"><span class="text-red">*</span> Existing Retailer</label>
                    ...
                    <div class="col-sm-6 col-sm-offset-4">
                      <div class="form-group mt-xs">
                        <div class="col-xs-12 text-left">
                          <h4 class="label" style="color:#000;">Preferred Electricity Price Model(Select more then 1 model)</h4>
                        </div>
                      </div>
                      @foreach($estimate as $key => $value)
                      <div class="checkbox col-xs-offset-1">
...
<script>
  $('.r_avg_consumtion,.b_avg_consumtion').keypress(function(event) {
...
$("#ResidentailPhoto1").change(function(){
    readURL1(this);
});
...
$("#ResidentailPhoto2").change(function(){
    readURL2(this);
});
function readURL3(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function (e) {
          $('#img_preview3').attr('src', e.target.result).show();
      }
      reader.readAsDataURL(input.files[0]);
  }
}
$("#BusinessPhoto1").change(function(){
    readURL3(this);
});
function readURL4(input) {
  if (input.files && input.files[0]) {
      var reader = new FileReader();
      reader.onload = function (e) {
          $('#img_preview4').attr('src', e.target.result).show();
      }
      reader.readAsDataURL(input.files[0]);
  }
}
$("#BusinessPhoto2").change(function(){
    readURL4(this);
});
  $(function () {
