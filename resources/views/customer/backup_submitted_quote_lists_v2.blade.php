                        ...
                        <tr>
                          ...
                          <td class="est_amount_save" id="est_amount_save">
                            @if($type_id==1)
                              ...
                              @else
                                {{number_format($sp_tariff->value - ($sp_tariff->value - (($value->peak/100)*$sp_tariff->value)),3)}}
                              @endif  
                            @else
                              @if($value->type=="F")
                                 $ {{$value->avr_consumtion*($sp_tariff->value - $value->qprice)}}
                              @else
                                {{number_format($sp_tariff->value - ($sp_tariff->value - (($value->qprice/100)*$sp_tariff->value)),3)}}
                              @endif
                            @endif
                          </td>
                          <td>
