              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-12 form-horizontal">
                    <div class="col-md-6">
                      <div class="row mt-xs">
                        <div class="col-sm-6 text-form-mobile"><b>Request ID :</b></div>
                        <div class="col-sm-6">{{$value->random_request_id}}</div>
                      </div>
                      <div class="row mt-xs">
                        <div class="col-sm-6 text-form-mobile"><b>Business Type :</b></div>
                        <div class="col-sm-6">{{$value->type_id == 1?"Business":"Residential"}}</div>
                      </div>
                      <div class="row mt-xs">
                        <div class="col-sm-6 text-form-mobile"><b>SP Tariff :</b></div>
                        <div class="col-sm-6">{{$sp_tariff->value}} $/kWh</div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      <div class="row mt-xs">
                        <div class="col-sm-6 text-form-mobile"><b>Premise :</b></div>
                        <div class="col-sm-6">{{$value->premise_address}}</div>
                      </div>
                      @if($type_id == 2)
                      <div class="row mt-xs">
                        <div class="col-sm-6 text-form-mobile"><b>Type of Dwellings :</b></div>
                        <div class="col-sm-6">{{$value->dwe_name}} {{$value->dwe_detail}}</div>
                      </div>
                      @endif
                      <div class="row mt-xs">
                        <div class="col-sm-6 text-form-mobile"><b>Average Consumption :</b></div>
                        <div class="col-sm-6">{{$value->avr_consumtion}} kWh</div>
                      </div>
                    </div>
                  </div><br>
                  <div class="col-xs-12 form-horizontal table-responsive"><hr>
                    ...
                    <!-- <div class="row"> -->
                      ...
                      <!-- <div class="row"> -->
                        ...
                        <div class='form-group col-sm-6'>
                          <div class="row">
                            <div class="col-sm-12">
                              <p for="estimated_save" class="control-label">Estimated amount saved per month</p>
                            </div>
                            <div class="col-sm-12">
                          ...
                          <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                              <div class="form-group">
                                <div class="col-sm-12" id="promotion_detail"></div><br><br>
                                <div class="promotion_image_business" id="promotion_image_business"></div>
                              </div>
                            </div>
                          </div>
                      ...
                      <div class="row">
                        <div class="col-sm-6 col-sm-offset-3">
                          <a type="button" href="{{url('Customer/ViewSubmittedQuotes')}}" class="col-sm-6 btn btn-danger btn-lg">Back</a>
                      ...
                      <div class="modal-dialog" role="document">
                        <div class="modal-content">
                          <div class="modal-header">
                            ...
                            <a href=""><h4 class="modal-title contract_title" id="myModalLabel"></h4></a>
                          </div>
                          <div class="modal-body contract">
                            ...
                            <div class="form-group">
                              ...
                              <label class="control-label text-right text-left-xs"></label>
                                <input type="checkbox" id="term_condition" name="term_condition" title="Please agree to our policy!"> I agree to the selected Retailer's terms and conditions. 
                              </div>
                            </div>
                          ...
                          <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn-submit">Yes, I agree</button>
                          </div>
                        </div>
                      </div>
                    </div>
                  ...
                  <form id="FormResidetail" class="FormResidetail">
                    ...
                    <div class="row">
                      ...
                      <div class='form-group col-sm-6'>
                        ...
                        <!-- <input type="text" class="form-control estimated_save_res" id="estimated_save_res" placeholder="Estimated amount saved per month" value="" readonly> -->
                      </div>   <!-- ./form-group -->
                    </div><!-- ./row -->
                    <div class="row">
                      <div class='form-group col-sm-6'>
                      ...
                      <div class='form-group col-sm-6'>
                        ...
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body">
                            <div class="form-group">
                              <div class="col-sm-12" id="promotion_detail"> </div><br> <br>
                              <div class="promotion_image_res" id="promotion_image_res"></div>
                            </div>
                          </div>
                        </div>
                      </div><!-- ./form-group col-sm-6 -->
                        ...
                        <div class="modal-content">
                          ...
                          <div class="modal-body contract">
                            ...
                            <div class="form-group">
                              <div class="col-md-12">
                              <label class="control-label text-right text-left-xs"></label>
                                <input type="checkbox" id="term_condition" name="term_condition"> I agree to the selected Retailer's terms and conditions. 
                              </div>
                            </div>
                          </div>
                          <div class="modal-footer">
...
$("#photo_id_card").change(function(){
  ...
  $('body').on('click','.btn-edit',function(data){
    if(type_id==1) {
      ...
      // $('#estimated_save_res').val($(this).closest('tr').find('#est_amount_save').text());
    ...
    $.ajax({
      ...
      if(rec == null) {
        ...
        if (rec.quote_promotion.title == null) {
          $('.promotion_box').hide(); 
        }
        if (rec.quote_promotion.images != null) {
        ...
        if (rec.quote_promotion.files == null) {
          $('#promotion_title').html(rec.quote_promotion.title);  
        }else{
...
$('body').on('click','.btn-submit', function(){
  // console.log($("body").find('#SelectBusinessModal').find('#term_condition')[0]);
  $("body").find('#SelectBusinessModal').find('#term_condition').rules( "add", {
    required: true,
    messages: {
      required: "Required input",
    }
  });
  // if ($("body").find('#SelectBusinessModal').find('#term_condition').prop('checked',true)) {
  //   $('#term-condition').closest('div').find('span').remove();
  //   $('#term-condition').closest('div').append('<span id="condition-error" class="help-block">This field is required.</span>');
  // }
  $("#FormBusiness").submit();
    $('body').find('#SelectBusinessModal').find('.has-error').find('label').html('Required terms and conditions &nbsp;&nbsp;&nbsp;');
  // console.log($('body').find('#SelectBusinessModal').find('.has-error').find('label')[0]);
  // $("body").find('#SelectBusinessModal').find('#term_condition').closest('div.col-md-12').append($('body').find('#SelectBusinessModal').find('.has-error').find('label')[0]);
});

$('body').on('click','.btn-submit', function(){
  // console.log($("body").find('#SelectBusinessModal').find('#term_condition')[0]);
  $("body").find('#SelectResidentailModal').find('#term_condition').rules( "add", {
    required: true,
    messages: {
      required: "Required input",
    }
  ...
  $("#FormResidetail").submit();
    $('body').find('#SelectResidentailModal').find('.has-error').find('label').html('Required terms and conditions &nbsp;&nbsp;&nbsp;');
});

$('body').on('click','#term_condition',function() {
  if($(this).prop('checked')==false) 
    $('body').find('#SelectBusinessModal').find('.has-error').find('label').html('Required terms and conditions &nbsp;&nbsp;&nbsp;');
  else
    $('body').find('#SelectBusinessModal').find('.has-error').find('label').html('');
...
$('body').on('click','#term_condition',function() {
  if($(this).prop('checked')==false) 
    ...
    $('body').find('#SelectResidentailModal').find('.has-error').find('label').html('');
