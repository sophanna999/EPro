            ...
            <div class="content-box-fullwidth">
              ...
              <div class="col-lg-9">
                <div class="content-head">
                  <h4><i class="fa fa-user"></i> Create Terms and Conditions </h4>
                </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 form-horizontal">
                        <div class="form-group">
                            <label class="control-label col-xs-4 text-right">Name Of Document: </label>
                            <div class="col-xs-12 col-sm-5">
                              <input class="form-control" type="text" name="contract_name" id="contract_name">
                            </div>
                          </div>
                        <div class="form-group">
                          <label class="control-label col-xs-4 text-right">Upload : </label>
                            <div class="col-xs-12 col-sm-5">
                        ...
                        <div class="form-group">
                          <div class="col-md-offset-4 col-md-8 text-left">
                            <input class="btn-primary btn" type="submit" value="Upload">
                          </div>
                        </div>
                      </div>
                    </div>
