                  ...
                  <div class="container-fluid">
                      <div class="col-xs-12 form-horizontal">
                          <div class="lowtension">
                            <form class="FormEditOffer" id="FormEditOffer">
                              <input type="hidden" name="" id="offer_id" value="{{$offer_data->post_offer_id}}">
                              ...
                              <div class="form-group">
                                  ...
                                  <div class="col-md-5">
                                      <input class="form-control" type="text" name="retailer_name" id="retailer_name" value="{{$offer_data->retailer_name}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-md-4 text-right">Offer Title</label>
                                  <div class="col-md-5">
                                      <input class="form-control" type="text" name="title" id="title" value="{{$offer_data->title}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-md-4 text-right">Offer Description</label>
                                  <div class="col-md-5">
                                      <textarea class="form-control" rows="5" name="detail" id="detail" value="{{$offer_data->detail}}">{{$offer_data->detail}}</textarea>
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-md-4 text-right">Promotion Duration from</label>
                                  <div class="col-md-2" id="datetimepicker" data-date="12-02-2012" data-date-format="dd-mm-yyyy">
                                      <input class="form-control" type="text" name="promotion_start" id="promotion_start" value="{{$offer_data->promotion_start}}">
                                  </div>
                                  
                                  <p class="form-control-static text-center col-md-1">to </p>
                                  <div class="col-md-2">
                                      <input class="form-control" type="text" name="promotion_end" id="promotion_end" value="{{$offer_data->promotion_end}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-md-4 text-right">Contact Person</label>
                                  <div class="col-md-5">
                                      <input class="form-control" type="text" name="contact_person" id="contact_person" value="{{$offer_data->contact_person}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-md-4 text-right">Contact Number</label>
                                  <div class="col-md-5">
                                      <input class="form-control" type="text" name="contact_number" id="contact_number" value="{{$offer_data->contact_number}}">
                                  </div>
                              </div>
                              <div class="form-group">
                                  <label class="control-label col-md-4 text-right">Contact Email</label>
                                  <div class="col-md-5">
                                      <input class="form-control" type="text" name="contact_email" id="contact_email" value="{{$offer_data->contact_email}}">
                                  </div>
                              </div>
                          </div>
                          <div class="form-group">
...
<script>
  ...
  $('#FormEditOffer').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/Retailer/PostOffer/"+id,
                dataType : 'json',
                data : $(form).serialize()
            }).done(function(rec){
                btn.button("reset");
  ...
  $('#photo').orakuploader({
    ...
    @if($offer_data->photo)
        ...
        orakuploader_attach_images: ['{{$offer_data->photo}}'],
    @else
        orakuploader_maximum_uploads : 1
    @endif
});
