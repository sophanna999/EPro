            ...
            <div class="content-box-fullwidth">
              ...
              <div class="col-lg-9">
                ...
                <div class="content-head">
                  <h4><i class="fa fa-user"></i>  Change Password For Retailer</h4>
                </div>
                <div class="container-fluid">
                  <form action="" id="ChangePasswordRetailer">
                    <div class="row">
...
<script>
  ...
  $('#ChangePasswordRetailer').validate({
        errorElement: 'span',
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/Retailer/ChangePassword",
                dataType : 'json',
                data : $(form).serialize()
            }).done(function(rec){
                btn.button("reset");
