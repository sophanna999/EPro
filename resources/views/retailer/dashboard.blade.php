                  ...
                  <form action="" id="FormSaveProfile">
                    <div class="row">
                      <div class="col-xs-12 form-horizontal">
                        ...
                        <div class="form-group">
                          <label class="control-label col-md-4 text-right">Company Name:</label>
                          <div class="col-md-5">
                            <p class="form-control-static">{{$user->company}}</p>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-md-4 text-right">First Name</label>
                          <div class="col-md-5">
                            <input class="form-control" name="firstname" type="text" value="{{$user->firstname}}">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="control-label col-md-4 text-right">Last Name</label>
                          <div class="col-md-5">
            ...
            $.ajax({
                ...
                if(rec.status==1){
                    ...
                    swal({
                      ...
                      window.location = url_gb+"/Retailer/Dashboard";
                    });
                }else{
