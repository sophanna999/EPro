    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="TableRetailerCondition">
                    <thead>
                        <tr>
                            <th>No.</th>
...
<script>
    $('#file_name').change(function() {
     ...
     var TableRetailerCondition = $('#TableRetailerCondition').dataTable({
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": url_gb+"/admin/RetailerCondition/ListRetailerCondition",
            "data": function ( d ) {
                //d.myKey = "myValue";
    ...
    $('body').on('submit','#FormAdd', function(e){
        ...
        $.ajax({
          url: url_gb+"/admin/RetailerCondition/Store",
          data: formData,
          type: 'POST',
          ...
          success : function(rec){
            ...
            if (data.status == 1) {
              swal({
                ...
                window.location = url_gb+'/admin/RetailerCondition';
              });
            }else{
              swal({
                position: 'center',
    ...
    $('body').on('submit','#FormEdit', function(e){
        ...
        var formData = new FormData(form);
        $.ajax({
          url: url_gb+"/admin/RetailerCondition/update/"+id,
          data: formData,
          type: 'POST',
          contentType: false, // NEEDED, DON'T OMIT THIS (requires jQuery 1.6+)
          processData: false, // NEEDED, DON'T OMIT THIS
    ...
    $("body").on("click",".btn-delete",function(){
        ...
        swal({
            ...
            if(data){
                $.ajax({
                    method : "POST",
                    url : url_gb+"/admin/RetailerCondition/delete/"+id,
                    data : {ID : id}
                }).done(function(data){
                    if(data){
                        ...
                        if(rec.status==1){
                            ...
                            TableRetailerCondition.api().ajax.reload();
                        }else{
