...
<script>
     var TableAbout = $('#TableAbout').dataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": url_gb+"/admin/About/ListAbout",
            "data": function ( d ) {
                //d.myKey = "myValue";
    ...
    $('#FormAdd').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/admin/About",
                dataType : 'json',
                data : $(form).serialize()
            }).done(function(rec){
                btn.button("reset");
                if(rec.status==1){
                    TableAbout.api().ajax.reload();
    ...
    $('#FormEdit').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/admin/About/CheckEdit/"+id,
                dataType : 'json',
                data : $(form).serialize()
            }).done(function(rec){
                btn.button("reset");
...
$("body").on("click",".btn-delete",function(){
        ...
        swal({
            ...
            if(data){
                $.ajax({
                    method : "POST",
                    url : url_gb+"/admin/About/Delete/"+id,
                    data : {ID : id}
                }).done(function(data){
                    if(data){
...
$('#photo').orakuploader({
    ...
    orakuploader_main_path : 'uploads/abouts/',
    orakuploader_thumbnail_path : 'uploads/abouts/',                
    orakuploader_thumbnail_real_path : asset_gb+'uploads/abouts/',  
