    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="table-responsive">
                <table class="table table-hover" id="TableContactDetail">
                    <thead>
                        <tr>
                            <th>No.</th>
                            <th>Email</th>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="edit_email" id="edit_email" placeholder="Enter Your Email">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="edit_fax" id="edit_fax" placeholder="Enter Your Fax">
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="edit_address">Address</label>
                            <input type="text" class="form-control" name="edit_address" id="edit_address" placeholder="Enter Your Address">
                        </div>
                    </div>
                </div>
            </div>
...
@section('js_bottom')
<script>
     var TableContactDetail = $('#TableContactDetail').dataTable({
        "processing": true,
        "serverSide": true,
        "ajax": {
            "url": url_gb+"/admin/ContactDetail/ListContactDetail",
            "data": function ( d ) {
                //d.myKey = "myValue";
    ...
    $('body').on('click','.btn-edit',function(data){
        ...
        $.ajax({
            method : "GET",
            url : url_gb+"/admin/ContactDetail/"+id,
            dataType : 'json'
        }).done(function(rec){
            $('#edit_id').val(rec.id);
            $('#edit_email').val(rec.email);
            $('#edit_phone').val(rec.phone);
            $('#edit_fax').val(rec.fax);
    ...
    $('#FormEdit').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/admin/ContactDetail/CheckEdit/"+id,
                dataType : 'json',
                data : $(form).serialize()
            }).done(function(rec){
                btn.button("reset");
...
$("body").on("click",".btn-delete",function(){
        ...
        swal({
            ...
            if(data){
                $.ajax({
                    method : "POST",
                    url : url_gb+"/admin/ContactDetail/Delete/"+id,
                    data : {ID : id}
                }).done(function(data){
                    if(data){
