            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="link">Link</label>
                            <input type="text" class="form-control" name="edit_link" id="edit_link" placeholder="Enter Your link">
                        </div>
                    </div>
                </div>
            </div>
...
<script>
     var TableBanner = $('#TableBanner').dataTable({
        ...
        "serverSide": true,
        "ajax": {
            "url": url_gb+"/admin/Banner/ListBanner",
            "data": function ( d ) {
                //d.myKey = "myValue";
    ...
    $('#FormEdit').validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                method : "POST",
                url : url_gb+"/admin/Banner/CheckEdit/"+id,
                dataType : 'json',
                data : $(form).serialize()
            }).done(function(rec){
                btn.button("reset");
